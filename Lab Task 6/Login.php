...
<head>
    ...
    <title>Train_Managers_Login</title>
    <style>
        .error {
            color: red;
        }
...
<body>
    ...
    session_start();
    $msg = '';
    $tm_Email = "tm@gmail.com";
    $tm_Password = "tm";

    if (isset($_POST['email']) && isset($_POST['password'])) {
        if ($_POST['email'] == $tm_Email && $_POST['password'] == $tm_Password) {
            $_SESSION['email'] = $tm_Email;
            $_SESSION['password'] = $tm_Password;
