...
<html lang="en" dir="ltr">
  ...
  <body>
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST")
   {
     if (empty($_POST["cpassword"])) {
      ...
      $cpassword = test_input($_POST["cpassword"]);
       ...
       if (strcmp($cpassword,"Farhad@888")) {
        ...
        if (empty($_POST["npassword"])) {
         ...
         $npassword = test_input($_POST["npassword"]);
          ...
          if (!strcmp($npassword,"Farhad@888")) {
   ...
   function test_input($data) {
    ...
    <p><h3 style="color:blue;">Change Password :</h3></p>
    <form style="border:3px; border-style:solid; border-color:gray; padding: 3em;" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
